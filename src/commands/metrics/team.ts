...
export default class MetricsTeam extends BaseCommand {
  ...
  static examples = [
    ...
    '<%= config.bin %> metrics team --fy 2025 --nrf-week 48 --group-by location_group',
    '<%= config.bin %> metrics team --period "nrf week 48 in FY2025" --group-by all',
  ...
  static flags = {
    ...
    calendar: Flags.string({options: ['nrf', 'retail', 'merch', 'fiscal'], description: 'Calendar system for FY/week/month/quarter flags'}),
    ...
    period: Flags.string({description: 'Parse an NRF phrase, e.g. "nrf week 48 in FY2025"'}),
